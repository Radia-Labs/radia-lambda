...
exports.handler = async (event, context) => {
  ...
  // initiate CheckSpotifyUserRecentPlayed step function
  try {
    ...
    const STEP_FUNCTION_ARN = 'arn:aws:states:us-east-1:722242270459:stateMachine:CheckSpotifyUserRecentPlayedStateMachine';    
